...
""" 
TODO: There needs to be a better way to add functions to assistants
Need to look into writing a script that takes a ReACT Agent class and identifies the tools then gets the schema
Then either try and add all (duplicates?) or attempt to get a delta between what exists and what is new
"""
